...
public abstract class Subscriber implements Cloneable, AutoCloseable, Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4183757671568710096L;
	private int subscriberId;
	private String name;
	private float subscriberNo;
	private float subscriptionCost;
	private static final String className="eu.ase.test.Subscriber";
	private static int subscribersNo=0;
	
	public Subscriber() {
		subscribersNo++;
	}
	
	public Subscriber(int subscriberId, String name, float subscriberNo, float subscriptionCost) throws Exception {
	...
	public static void setSubscribersNo(int subscribersNo) {
		Subscriber.subscribersNo = subscribersNo;
	}
	...
	protected Object clone() throws CloneNotSupportedException {
		subscribersNo++;
		Subscriber subscriber=(Subscriber)super.clone();
	...
	public abstract String getAbstractSubscriberId();
