...
public class ProgMain {
	...
	public static void main(String[] args) {
		/*
		VipPassenger pv1, pv2, pv3;
		try {
			pv1 = new VipPassenger(11, "John", 12, 20, "B123");
			pv2 = new VipPassenger(12, "John", 13, 21, "B124");
			pv3 = new VipPassenger(12, "John", 13, 21, "B124");
			if (pv1.equals(pv2))
			...
			VipPassenger[][] objs = new VipPassenger[][]{{pv1, pv2, null}, {null, pv3, null}};
